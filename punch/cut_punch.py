...
def PunchMaking():
    ...
    plate_line_cut_line_number[1][2] = 1
    plate_line_cut_line_number[1][3] = 4
    plate_line_cut_line_number[1][4] = 1
    plate_line_cut_line_number[1][6] = 4
    plate_line_cut_line_number[1][7] = 1
...
def punch_change(InterferancePadName, InterferanceLineName, NowPlateLineNumber, OpNumber, NowDataNumber,
    ...
    if Mode_status == '開模':
        ...
        # Thickness + stripper_plate_height + stop_plate_height + splint_height + upper_die_open_height
    elif Mode_status == '閉模':
        length1.value = (float(strip_parameter_list[1]) + float(strip_parameter_list[20]) + float(
    ...
    parameter1 = parameters1.Item("cut_line_formula_1")
    ...
    product1 = partDocument1.GetItem("op20_cut_punch_01")
