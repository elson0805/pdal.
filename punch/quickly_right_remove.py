...
def PunchMaking():
    ...
    total_op_number = 7
    plate_line_right_quickly_remove_cut_line_number = [[0] * 99 for i in range(99)]
    plate_line_right_quickly_remove_cut_line_number[1][2] = 1
    plate_line_right_quickly_remove_cut_line_number[1][3] = 0
    plate_line_right_quickly_remove_cut_line_number[1][4] = 0
    plate_line_right_quickly_remove_cut_line_number[1][6] = 0
    plate_line_right_quickly_remove_cut_line_number[1][7] = 0

    for now_op_number in range(1, total_op_number + 1):
        n = now_op_number
        op_number = 10 * n
        if plate_line_right_quickly_remove_cut_line_number[g][n] > 0:
            for now_data_number in range(1, plate_line_right_quickly_remove_cut_line_number[g][n] + 1):  #
                part_open('Data1.CATPart')
                interferance_pad_name = "right_quickly_remove_cut_punch"
                interferance_line_name = "_right_quickly_remove_cut_line_"
...
def punch_change(InterferancePadName, InterferanceLineName, NowPlateLineNumber, OpNumber, NowDataNumber,
    ...
    modify_name = plate_line_ + g + _op + op_number + InterferanceLineName
    creat_point_name1 = "right_quickly_remove_cut_line_Ymax_point"
    creat_point_name2 = "right_quickly_remove_cut_line_Ymin_point"
    X_direction1 = 0
    Y_direction1 = 1
    Z_direction1 = 0
    first_direction1 = 1
    ...
    part1.UpdateObject(body1)  # 設定工作物件
