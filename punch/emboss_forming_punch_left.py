...
def PunchMaking():
    ...
    total_op_number = 7
    plate_line_emboss_forming_punch_left_surface_number = [[0] * 99 for i in range(99)]
    plate_line_emboss_forming_punch_left_surface_number[1][2] = 1
    plate_line_emboss_forming_punch_left_surface_number[1][3] = 0
    plate_line_emboss_forming_punch_left_surface_number[1][4] = 0
    plate_line_emboss_forming_punch_left_surface_number[1][6] = 0
    plate_line_emboss_forming_punch_left_surface_number[1][7] = 0

    for now_op_number in range(1, total_op_number + 1):
        n = now_op_number
        op_number = 10 * n
        if plate_line_emboss_forming_punch_left_surface_number[g][n] > 0:
            for now_data_number in range(1, plate_line_emboss_forming_punch_left_surface_number[g][n] + 1):  #
                part_open('Data1.CATPart')
                interferance_pad_name = "_emboss_forming_punch_left_"
                interferance_line_name = "_emboss_forming_punch_left_surface_"
